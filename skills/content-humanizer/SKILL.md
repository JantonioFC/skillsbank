...
description: 'Makes AI-generated content sound genuinely human — not just cleaned
  ...
  it more human'', ''add personality'', ''it feels generic'', ...'
license: MIT
metadata:
  version: 1.0.0
...
Makes AI-generated content sound genuinely human — not just cleaned up, but alive. Use when content feels robotic, uses too many AI clichés, lacks personality, or reads like it was written by committee.

Covers: Before Starting, What you need, How This Skill Works, Mode 1: Detect — AI Pattern Analysis, Mode 2: Humanize — Pattern Removal and Rhythm Fix.
