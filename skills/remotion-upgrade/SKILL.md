...
Use this skill when asked to upgrade or update a Remotion project — Remotion core, its related and compatible Mediabunny packages, and any installed Remotion Agent Skills.
