...
description: When the user wants to create or update a README.md file for a project.
  ...
  'project documentation,' or asks for help with README.md. This skill creates absurdly
  thorough documentation covering local setup, architecture, and deployment.
