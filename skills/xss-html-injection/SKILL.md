...
description: This skill should be used when the user asks to "test for XSS vulnerabilities",
  ...
  security policies". It provides comprehensive techn...
metadata:
  author: zebbern
  version: '1.1'
risk: offensive
...
This skill should be used when the user asks to "test for XSS vulnerabilities", "perform cross-site scripting attacks", "identify HTML injection flaws", "exploit client-side injection vulnerabilities", "steal cookies via XSS", or "bypass content security policies".

Covers: Cross-Site Scripting and HTML Injection Testing, Required Access, Technical Requirements, Legal Prerequisites, Vulnerability Detection.
